...
function main() {
    ...
    // epoch5Arb
    calcEpoch('./epoch5Arb.json')

    // epoch6Bsc
    calcEpoch('./epoch6Bsc.json')
    ...
    // bscGasRebate8
    calcEpoch("./bscGasRebate8.json")

    // bscGasRebate9
    calcEpoch("./bscGasRebate9.json")

    // bscGasRebate10
    calcEpoch("./bscGasRebate10.json")

    // bscGasRebate11
    calcEpoch("./bscGasRebate11.json")
}
